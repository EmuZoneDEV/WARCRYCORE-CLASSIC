...
void WhoAction::InitSkills()
{
    ...
    skills[SKILL_ALCHEMY] = "Alchemie";
    skills[SKILL_ENCHANTING] = "Verzauberung";
    skills[SKILL_SKINNING] = "Kurschnerei";
    skills[SKILL_TAILORING] = "Schneidern";
    skills[SKILL_LEATHERWORKING] = "Lederverarbeitung";
    skills[SKILL_ENGINEERING] = "Ingeneurswesen";
    skills[SKILL_HERBALISM] = "Krauterkunde";
    skills[SKILL_MINING] = "Bergbau";
    skills[SKILL_BLACKSMITHING] = "Schmiedekunst";
    skills[SKILL_COOKING] = "Kochkunst";
    skills[SKILL_FIRST_AID] = "Erste Hilfe";
    skills[SKILL_FISHING] = "Kochkunst";
}
