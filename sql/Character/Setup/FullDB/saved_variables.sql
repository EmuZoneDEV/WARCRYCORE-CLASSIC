...
CREATE TABLE `saved_variables` (
  `NextMaintenanceDate` int(11) unsigned NOT NULL DEFAULT '0' COMMENT 'The Date when the Honor Points / Rank etc. are updated.',
...
-- Dump completed on 2019-07-08  0:25:54
